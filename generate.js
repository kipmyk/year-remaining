...
class YearProgress {
    ...
    calculateRemainingPercentage() {
        ...
        if (this.dayOfYear >= daysInYear) {
            ...
            this.remainingPercentage = 1 - this.dayOfYear / daysInYear;

            const precisionThreshold = 273;
            if (parseFloat(this.remainingPercentage.toFixed(3).split('.')[1].slice(2, 5)) <= precisionThreshold) {
